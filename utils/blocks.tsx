	...
	>
		{page_data.map(
			(comp: any, i: number) => {
				...
				if (compName === 'Error') return <Error  {...comp} key={i} preset={preset} iterator={i} />
				if (compName === 'Link') return <Link legacyBehavior  {...comp} key={i} preset={preset} iterator={i} />
				if (compName === 'Paragraph') return <Paragraph
					{...comp}
					key={i}
					preset={preset}
					iterator={i}
				...
				/>
				if (compName === 'Textgallery') return <Textgallery  {...comp} key={i} preset={preset} iterator={i} />
				//@endindex
